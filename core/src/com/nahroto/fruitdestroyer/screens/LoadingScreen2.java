...
public class LoadingScreen2 implements Screen
{
    ...
    public LoadingScreen2(final Application APP, final Font font, Texture bg)
    {
        ...
        gameHud = new GameHud(player, APP.viewport, APP, APP.batch, gameScreenAtlas.findRegion("reload-up"), gameScreenAtlas.findRegion("reload-down"), gameScreenAtlas.findRegion("bullet-icon"), gameScreenAtlas.findRegion("volumeButton"), actionMusic);
