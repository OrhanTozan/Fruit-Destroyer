...
public class GameResetter
{
    ...
    public void setOverlays(ExtraAmmoOverlay extraAmmoOverlay, ExtraDamageOverlay extraDamageOverlay, ExtraReloadSpeedOverlay extraReloadSpeedOverlay, ExtraKnockbackOverlay extraKnockbackOverlay, PowerupOverlay marksmanOverlay, PowerupOverlay instaKillOverlay, PowerupOverlay bombOverlay)
    {
        this.extraAmmoOverlay = extraAmmoOverlay;
        this.extraDamageOverlay = extraDamageOverlay;
